...
ORDER BY DEPT_CODE;--4 --ORDER BY는 무조건 마지막 실행 -> 정렬은 마지막 해주는 것이 아니면 의미 X

--각 직급별 총 사원 수, 보너스를 받는 사람 수, 급여합, 평균급여, 최저급여, 최고급여 (정렬 = 직급 오름차순)
...
--2.INTERSECT(교집합)
--부서코드가 D5이면서도 급여도 300만원 초과인 사원들의 사번, 이름 ,부서코드, 급여조회
SELECT EMP_ID, EMP_NAME, DEPT_CODE, SALARY
FROM EMPLOYEE
WHERE DEPT_CODE = 'D5' OR SALARY > 3000000;
