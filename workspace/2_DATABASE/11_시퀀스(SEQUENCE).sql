...
/*
    ...
    시퀀스명.NEXTVAL : 시퀀스 값에 일정한 값을 증가시켜 발생한 값
                    다음번실행시 현재 시퀀스값에 INCREMENT BT 값 만큽 증가한 값
*/
...
-->왜? CURRVAL는 마지막으로 성공한 NEXTVAL 의 값을 저장해서 보여주는 임시값이기 때문
...
INSERT INTO EMPLOYEE(EMP_ID, EMP_NAME, EMP_NO, JOB_CODE,HIRE_DATE)
        VALUES(SEQ_EID.NEXTVAL, '김용담', '111111-2111111','J6', SYSDATE);
