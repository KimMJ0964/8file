/*
    ...
    *변경할 내용
    1) 컬럼 추가/수정/삭제
    2) 제약조건 추가/삭제 -> 수정은 불가(삭제하고 다시만들기)
    3) 컬럼명/제약조건명/테이블명 변경 
*/
...
--위에서 이미 DEFAULT 처리를 한국으로 된 것들은 한국이지만 이 이후에는 미국으로 처리된다.
...
ALTER TABLE DEPT_TABLE RENAME CONSTRAINT SYS_C007308 TO DTABLE_NN;
