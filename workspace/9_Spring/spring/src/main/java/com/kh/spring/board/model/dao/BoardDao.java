...
public class BoardDao {
	...
	public List<Board> searchByCondition(SqlSessionTemplate sqlSession, Map<String, String> searchParams) {
		return sqlSession.selectList("boardMapper.searchBoard", searchParams);
	}
