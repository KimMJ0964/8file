 ...
 * Generated at: 2024-10-15 01:35:57 UTC
...
public final class boardDetailView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("            <script>\r\n");
      out.write("                function postFormSubmit(type){\r\n");
      out.write("                    const formEl = document.querySelector(\"#postForm\");\r\n");
      out.write("                    switch(type){\r\n");
      out.write("                        case \"edit\" : {\r\n");
      out.write("                            //formEl.action = \"updateForm.bo\";\r\n");
      out.write("                            $(formEl).attr(\"action\", \"updateForm.bo\");\r\n");
      out.write("                        }break;\r\n");
      out.write("                        case \"delete\":{\r\n");
      out.write("                            //formEl.action = \"delete.bo\";\r\n");
      out.write("                            $(formEl).attr(\"action\", \"delete.bo\")\r\n");
      out.write("                        }break;\r\n");
      out.write("                    }\r\n");
      out.write("                    \r\n");
      ...
      out.write("            \r\n");
      out.write("             <form action=\"\" method=\"post\" id=\"postForm\">\r\n");
      out.write("           		<input type=\"hidden\" name=bno value=\"7\">\r\n");
      out.write("           		<input type=\"hidden\" name=\"filePath\" value=\"이미지.jpg\">\r\n");
      out.write("             </form>\r\n");
      out.write("            \r\n");
      out.write("          \r\n");
      out.write(" \r\n");
      ...
      out.write("    <script>\r\n");
      out.write("        $(function() {\r\n");
      out.write("            const sendData = {\r\n");
      out.write("                bno : ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${b.boardNo}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
      out.write("            getReplyList(sendData, function(replyList){\r\n");
      out.write("                console.log(replyList)\r\n");
      out.write("\r\n");
      out.write("                // 댓글 갯수 나타내주는 함수 호출\r\n");
      out.write("                setReplyCount(replyList.length)\r\n");
      out.write("\r\n");
      out.write("                const replyBody = document.querySelector(\"#replyArea tbody\")\r\n");
      out.write("                // 댓글 목록 그려주는 함수 호출\r\n");
      out.write("                drawReplyList(replyBody, replyList);\r\n");
      out.write("            });\r\n");
      out.write("        })\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("        // 댓글 갯수 함수\r\n");
      out.write("        function setReplyCount(count) {\r\n");
      out.write("            document.querySelector(\"#rcount\").innerHTML = count;\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        // 댓글 목록 함수\r\n");
      out.write("        function drawReplyList(tBody, replyList) {\r\n");
      out.write("           \r\n");
      out.write("            // 단순하게 보여주기위한 view를 만들떄\r\n");
      out.write("            // for(reply of replyList) {\r\n");
      out.write("            //     str += '<tr>' +\r\n");
      out.write("            //                 '<td>' + reply.replyWriter + '</td>' +\r\n");
      out.write("            //                 '<td>' + reply.replyContent + '</td>' +\r\n");
      out.write("            //                 '<td>' + reply.createDate + '</td>' +\r\n");
      out.write("            //             '</tr>'\r\n");
      out.write("            // }\r\n");
      out.write("            // tBody.innerHTML = str;\r\n");
      out.write("\r\n");
      out.write("            // 이벤트를 넣는 뷰를 작성하고 싶을 떄\r\n");
      out.write("            for(const reply of replyList) {\r\n");
      out.write("                const replyRow = document.createElement('tr');  // <tr></tr>\r\n");
      out.write("                replyRow.innerHTML = '<td>' + reply.replyWriter + '</td>' +\r\n");
      out.write("                                     '<td>' + reply.replyContent + '</td>' +\r\n");
      out.write("                                     '<td>' + reply.createDate + '</td>';\r\n");
      out.write("                tBody.appendChild(replyRow);\r\n");
      out.write("\r\n");
      out.write("                replyRow.onclick = function() {\r\n");
      out.write("                    console.log(reply.replyNo + \"클릭됨\");\r\n");
      out.write("                }\r\n");
      out.write("            }\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("        // ajax 호출 후 결과 가져오기 (댓글 목록)\r\n");
      out.write("        function getReplyList(data, callback) {\r\n");
      out.write("            $.ajax({\r\n");
      ...
      out.write("\"\r\n");
      out.write("            const content = document.querySelector(\"#content\").value;\r\n");
      out.write("            \r\n");
      out.write("            addReplyAjax({\r\n");
      out.write("                refBno: boardNo,\r\n");
      out.write("                replyWriter: userId,\r\n");
      out.write("                replyContent: content\r\n");
      out.write("            }, function(res) {\r\n");
      out.write("                // res -> 성공, 실패\r\n");
      out.write("                if(res === \"success\") {\r\n");
      out.write("                    getReplyList({bno: boardNo}, function(replyList){\r\n");
      out.write("                        \r\n");
      out.write("                        setReplyCount(replyList.length)\r\n");
      out.write("                        drawReplyList(replyBody, replyList);\r\n");
      out.write("                    });\r\n");
      ...
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function addReplyAjax(data, callback) {\r\n");
      out.write("            $.ajax({\r\n");
      ...
      out.write("                },\r\n");
      out.write("                error: function() {\r\n");
      out.write("                    console.log(\"댓글 생성 ajax 실패\")\r\n");
      out.write("                }\r\n");
      out.write("            })\r\n");
      out.write("        }\r\n");
      out.write("    </script>\r\n");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/board/boardDetailView.jsp(65,13) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_c_005fif_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n");
          out.write("	                <a class=\"btn btn-primary\" onclick=\"postFormSubmit('edit')\">수정하기</a>\r\n");
          out.write("	                <a class=\"btn btn-danger\" onclick=\"postFormSubmit('delete')\">삭제하기</a>\r\n");
          out.write("                ");
  ...
  private boolean _jspx_meth_c_005fwhen_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fchoose_005f1, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/board/boardDetailView.jsp(105,18) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
